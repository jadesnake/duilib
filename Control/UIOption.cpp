...
{
	COptionUI::COptionUI() 
		: m_bSelected(false), m_dwSelectedTextColor(0),m_bSelBorder(false)
	{
	}
	...
	void COptionUI::SetSelBorder(bool bSel)
	{
		m_bSelBorder = bSel;
		Invalidate();
	}
	bool COptionUI::IsSelBorder()
	{
		return m_bSelBorder;
	}
	void COptionUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if( _tcscmp(pstrName, _T("selborder")) == 0 ) SetSelBorder(_tcscmp(pstrValue, _T("true")) == 0);
