...
typedef struct UILIB_API tagTListInfoUI
{
public:
	tagTListInfoUI()
	{
		...
		dwBkColor = 0;
		bAlternateBk = false;
		dwSelectedTextColor = 0xFF000000;
		dwSelectedBkColor = 0xFFC1E3FF;
		dwHotTextColor = 0xFF000000;
		dwHotBkColor = 0xFFE9F5FF;
		dwDisabledTextColor = 0xFFCCCCCC;
		dwDisabledBkColor = 0xFFFFFFFF;
		dwLineColor = 0;
		bShowHtml = false;
		...
		dwBorderSize = 0;
		dwHotBorderColor = 0xFF000000;
		dwSelectedBorderColor = 0xFF000000;
	}
	...
	DWORD dwHotBorderColor;			//add by jiayh
	DWORD dwBorderSize;				//add by jiayh
	DWORD dwSelectedBorderColor;	//add by jiayh
} TListInfoUI;
...
{
public:
    virtual CListHeaderUI* GetHeader()  = 0;
    virtual CContainerUI* GetList()  = 0;
...
public:
	...
	//Add by jade
	void Init();
	virtual CListBodyUI*	NewListBodyUI();
	virtual CListHeaderUI*	NewListHeaderUI();
	...
	void SetHotBorderColor(DWORD dwBkColor);	//add by jiayh
	void SetBorderSize(DWORD dwV);				//add by jiayh
	void SetSelectedBorderColor(DWORD dwBkColor);//add by jiayh
	...
	DWORD GetItemHotBorderColor(void) const;		//add by jiayh
	DWORD GetItemBorderSize(void) const;			//add by jiayh
	DWORD GetItemSelectedBorderColor(void) const;	//add by jiayh
...
protected:
	bool  m_bAutoFixedLst;			//fixed by jade 自动固定
