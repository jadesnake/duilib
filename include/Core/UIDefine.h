...
//user-define messages extended by st cpp team

//"killfocus_ew" is sent when CEditWnd received WM_KILLFOCUS message.
//When you minimize your window, you won't receive "killfocus" notify, 
//however, you will receive "killfocus_ew".
#define DUI_MSGTYPE_KILLFOCUS_EW 		   (_T("killfocus_ew"))
